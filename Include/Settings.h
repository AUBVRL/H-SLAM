...
extern FeatureType featType;
//Detector settings
// extern int IndPyrLevels;
// extern float IndPyrScaleFactor;
extern int featuresToExtract;
extern int minDist;
extern int minThFAST;
extern bool UseFAST;
extern bool DoSubPix;
extern float FASTRatio; // number of fast features=FASTRatio*featuresToExtract, remainder DSO feats  
