...
public:
	...
	inline IndexThreadReduce()
	{
		...
		maxIndex = 0;
		stepSize = 1;
		callPerIndex = bind(&IndexThreadReduce::callPerIndexDefault, this, placeholders::_1, placeholders::_2,
	...
	inline void reduce(function<void(int,int,Running*,int)> callPerIndex, int first, int end, int stepSize = 0)
	{
...
//		}
		...
		nextIndex = 0;
		maxIndex = 0;
		this->callPerIndex = bind(&IndexThreadReduce::callPerIndexDefault, this, placeholders::_1, placeholders::_2, 
								  placeholders::_3, placeholders::_4);
