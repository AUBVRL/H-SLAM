#ifndef __ACCUMULATEDSCHESSIAN_H__
#define __ACCUMULATEDSCHESSIAN_H__
...
public:
	...
	void addPoint(std::shared_ptr<MapPoint> p, bool shiftPriorToZero, int tid = 0);

	void stitchDoubleMT(shared_ptr<IndexThreadReduce<Vec10>> red, MatXX &H, VecX &b, EnergyFunctional const *const EF, bool MT)
	{
		...
		if (MT)
		{
			...
			red->reduce(bind(&AccumulatedSCHessianSSE::stitchDoubleInternal,
									this, Hs, bs, EF, placeholders::_1, placeholders::_2, placeholders::_3, placeholders::_4),
	...
	void addPointsInternal(
		std::vector<std::shared_ptr<MapPoint>> *points, bool shiftPriorToZero,
