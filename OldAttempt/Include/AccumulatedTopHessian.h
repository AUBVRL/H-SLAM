#ifndef __ACCUMULATEDTOPHESSIAN_H__
#define __ACCUMULATEDTOPHESSIAN_H__
...
public:
	...
	void stitchDoubleMT(shared_ptr<IndexThreadReduce<Vec10>> red, MatXX &H, VecX &b, EnergyFunctional const * const EF, bool usePrior, bool MT)
	{
